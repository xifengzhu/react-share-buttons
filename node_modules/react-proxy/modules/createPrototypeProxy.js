...
function createPrototypeProxy() {
  ...
  function defineProxyPropertyWithValue(name, value) {
    ...
    const enumerable = _ref$enumerable === undefined ? false : _ref$enumerable;
    var _ref$writable = _ref.writable;
    const writable = _ref$writable === undefined ? true : _ref$writable;
  ...
  function update(next) {
    ...
    const removedNames = (0, _difference2.default)(previousName, currentNames);
